...
有关详细信息，请参见 link:concept-licensing-charging.html["有关基于容量的许可证的更多信息"]。
...
要为Cloud Volumes ONTAP系统提供PAYGO和BYOL许可证、需要启动并运行BlueXP  Connector。有关详细信息，请参阅 https://docs.netapp.com/us-en/bluexp-setup-admin/concept-connectors.html#impact-on-cloud-volumes-ontap["了解连接器"^]。
