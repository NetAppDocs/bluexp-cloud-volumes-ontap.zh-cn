...
+
https://docs.netapp.com/us-en/snapcenter/get-started/concept_snapcenter_overview.html["了解有关 SnapCenter 的更多信息"^]
...
https://bluexp.netapp.com/ontap-cloud["了解有关 Cloud Volumes ONTAP 的更多信息"^]
