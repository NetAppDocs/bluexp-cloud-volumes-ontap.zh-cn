...
* https://["查看 AWS 中 Cloud Volumes ONTAP 的存储限制"^]
* http://["查看 AWS 中支持的 Cloud Volumes ONTAP 配置"^]
...
* https://["Microsoft Azure 文档： Azure 托管磁盘类型"^]
* https://["Microsoft Azure 文档： Azure 页面 Blobs 概述"^]
* link:task-planning-your-config-azure.html["了解如何在 Azure 中为您的系统选择磁盘类型和磁盘大小"]
* https://["查看 Azure 中 Cloud Volumes ONTAP 的存储限制"^]
...
* https://["Google Cloud文档：存储选项"^]
* https://["查看Google Cloud中Cloud Volumes ONTAP 的存储限制"^]
