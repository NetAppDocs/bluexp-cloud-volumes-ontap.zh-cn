...
如果无法从C4、M4或R4实例更改实例类型、请参见知识库文章 link:https://kb.netapp.com/Cloud/Cloud_Volumes_ONTAP/Unable_to_change_the_instance_type_from_r4_to_r5_with_disk_count_error["无法将实例类型从R4更改为R5、并出现磁盘数错误"^]。
