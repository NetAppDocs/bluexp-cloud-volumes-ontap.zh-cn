...
如果无法从C4、M4或R4实例更改实例类型、请参见知识库文章 link:https://kb.netapp.com/Cloud/Cloud_Volumes_ONTAP/Converting_an_AWS_Xen_CVO_instance_to_Nitro_(KVM)["将AWS Xen CVO实例转换为Nitro (KVM)"^]。
