...
NOTE: 这是您为BlueXP设置的服务帐户、 link:https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-google.html#set-up-a-service-account-for-the-connector["如本页所述"^]。
