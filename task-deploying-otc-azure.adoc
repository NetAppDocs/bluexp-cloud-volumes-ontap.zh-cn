...
+
对于单节点系统，您可以选择要在其中部署 Cloud Volumes ONTAP 的可用性区域。如果不选择 AZ ， Cloud Manager 将为您选择一个。
...
| Availability Zone | 对于单节点系统，您可以选择要在其中部署 Cloud Volumes ONTAP 的可用性区域。如果不选择 AZ ， Cloud Manager 将为您选择一个。 
...
| 已生成安全组  a| 
如果您让Cloud Manager为您生成安全组、则需要选择允许流量的方式：
