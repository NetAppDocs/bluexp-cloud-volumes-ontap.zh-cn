...
如果您没有 https://docs.netapp.com/us-en/bluexp-setup-admin/concept-connectors.html["连接器"^] 但是，客户管理员需要创建一个。 https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-aws.html["了解如何在 AWS 中创建连接器"^]
