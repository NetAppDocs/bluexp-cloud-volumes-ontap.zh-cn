...
大多数 Microsoft Azure 地区均支持 Cloud Volumes ONTAP 。 https://["查看支持的区域的完整列表"^]。
...
https://["支持 Azure 中 Cloud Volumes ONTAP 的配置"^]
...
https://["Azure 中 Cloud Volumes ONTAP 的存储限制"^]
...
有关这些磁盘的使用情形的其他详细信息，请参见 https://["Microsoft Azure 文档： Azure 中提供了哪些磁盘类型？"^]。
