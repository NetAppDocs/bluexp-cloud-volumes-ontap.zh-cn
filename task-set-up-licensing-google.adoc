...
.步骤
. https://["要获取许可证，请联系 NetApp 销售人员"^]
. https://["将您的NetApp 支持站点 帐户添加到BlueXP"^]
+
...
TIP: 您可以从"设置">"凭据"页面管理与您的帐户关联的Google Cloud Marketplace订阅。 https://["了解如何管理Google Cloud凭据和订阅"^]
