...
. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-nss-accounts.html#add-an-nss-account["将您的NetApp 支持站点 帐户添加到BlueXP"^]
+
BlueXP会自动查询NetApp的许可服务、以获取与您的NetApp 支持站点 帐户关联的许可证的详细信息。如果没有错误、BlueXP会自动将许可证添加到数字电子钱包中。
...
. mailto：ng-keystone-success@netapp.com (联系NetApp)授权您的BlueXP用户帐户进行一个或多个Keystone Flex订阅。
